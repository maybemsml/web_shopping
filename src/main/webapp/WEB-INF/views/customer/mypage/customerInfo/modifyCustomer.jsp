								...
								<table>
									...
									<tr>
										<td colspan=2 style=border-bottom:none>
											<br>
											<div align=right>
												<input type=submit class=inputButton value=회원수정>
												<input type=reset class=inputButton value=수정취소 onclick="window.location='${path}/main.do'">
											</div>
										</td>
									</tr>
								</table>
